...
import { AccountDeletionSection } from "@/features/users/components/account-deletion-section";
...
export function ProfileSettingsTab({
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
      ...
      <ProfileInvitationsPanel invitations={invitations} transfers={transfers} locale={locale} />

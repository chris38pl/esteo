...
import { IssuesListDateRangePicker } from "@/features/issues/components/issues-list-date-range-picker";
import type { IssuesListDateRange } from "@/features/issues/lib/issues-list-filter";
import type { Locale } from "@/lib/locale";
import { cn } from "@/lib/utils";

export function IssuesListToolbar({
  locale,
  searchQuery,
  onSearchQueryChange,
  filterActive,
  ...
  onDateRangeChange: (range: IssuesListDateRange) => void;
}) {

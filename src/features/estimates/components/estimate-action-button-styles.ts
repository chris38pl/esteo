...
export const estimateOutlineIconButtonClassName =
  "inline-flex size-9 shrink-0 items-center justify-center rounded-md border-blue-200 bg-background text-blue-600 shadow-xs hover:bg-blue-50 hover:text-blue-700 dark:border-input dark:bg-card dark:text-foreground dark:hover:bg-accent [&_svg]:shrink-0";

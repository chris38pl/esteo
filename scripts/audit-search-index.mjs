...
if (useStaging) {
  ...
  console.log("Auditing search index on Neon staging branch…");
} else {
  if (!databaseUrl) {
  ...
  console.log("Auditing search index on default DATABASE_URL (development)…");
}
...
const result = spawnSync(
  "npx",
  ["tsx", "scripts/audit-search-index.ts", ...(useStaging ? ["--staging"] : []), ...forwardArgs],
  {
    stdio: "inherit",
    env,
    shell: true,
